# Generated by Django 5.0.1 on 2024-02-19 22:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=16, validators=[core.validators.validate_color])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opposite', models.OneToOneField(help_text='The corresponding Connection which belongs to the other user. This is to ensure that if the owner disconnects from the other user, the other user also disconnects from the owner.', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.connection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduced', models.ForeignKey(help_text='The user the receiving user is being introduced to.', on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('opposite', models.OneToOneField(help_text='The corresponding Intro which was sent to indroduced user; ensures that deleting one intro deletes the other.', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.intro')),
                ('receiver', models.ForeignKey(help_text='The user the intro is sent to, who can accept the intro.', on_delete=django.db.models.deletion.CASCADE, related_name='intros', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(help_text='The user who is introducing the other two.', on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Invitation',
